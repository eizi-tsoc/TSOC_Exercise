/* TSOC Exercise v2.1.0 / Build018
   TEST storage isolation for /test/build011/
   - Production localStorage keys remain untouched.
   - Production IndexedDB databases remain untouched.
   - build009(Build016)・build010(Build017) の localStorage / IndexedDB とも完全分離する。
   - The test site gets its own localStorage namespace and IndexedDB databases.
*/
(() => {
  "use strict";

  const TEST_PREFIX = "tsoc_test_build011__";
  const DB_MAP = {
    "tsoc_admin_phase2_images": "tsoc_test_build011__tsoc_admin_phase2_images",
    "tsoc_visual_editor_v1": "tsoc_test_build011__tsoc_visual_editor_v1"
  };
